...
After comparing models, we can see that the Ridge Classifier has the highest Accuracy, Gradient Boosting Classifier has the highest Precision and F1 score, and the ExtraTrees Classifier ranks third in line, and finally the Random Forest Classifier has the highest Area Under the Curve (AUC).  These are the four models we will train, tune, and use to predict Adoption Speed in our data. 